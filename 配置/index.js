export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3eb450d8ffa68b85",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "d84b8cfa5f13690f11fcdf5dbf0d04cd",
  ...
  USERS: [
    {
      ...
      id: "otmQj5xLLWRpJhWcrhMBFxg3atUU",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "8clphIPVRmewcR7jfIzADXreeYiqw-Au1uGIetxjDv4",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "南京",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "周周宝贝", "year": "1994", "date": "10-18"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2019", "date": "12-15"},
